...
projectsRoutes.post("", developerMiddlewarers.developerIdExists, projectControllers.create)

projectsRoutes.use("/:id", projectMiddlewares.projectExists)

projectsRoutes.get("/:id", projectControllers.retrieve)
projectsRoutes.patch("/:id", developerMiddlewarers.developerIdExists, projectControllers.update)
